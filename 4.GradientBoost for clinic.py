...
clf = GradientBoostingClassifier(n_estimators=100, learning_rate=0.1, max_depth=3, random_state=2024)
...
plt.title('(b) GradientBoost', fontsize=18)
plt.savefig('.\\confusion matrice\\A2.pdf')  # 注意文件路径中的斜杠
plt.show()
