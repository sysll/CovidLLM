...
mapping = {'死亡': 1, '出院': 0}
feature = ['血_淋巴细胞(%)', '年龄', '血_超敏C反应蛋白', '血_中性粒细胞(%)',
           '高血压(0=无，1=有)', '血_D-D二聚体定量', '血_肌酐', '血_白蛋白', '血_直接胆红素']
...
clf = AdaBoostClassifier(base_estimator=base_estimator, n_estimators=100, learning_rate=1.0, random_state=2024)
...
plt.title('(A) AdaBoost', fontsize=18)
plt.savefig('.\\confusion matrice\\A1.pdf')  # 注意文件路径中的斜杠
plt.show()
