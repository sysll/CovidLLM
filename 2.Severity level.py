...
with open(file_path, 'r', encoding='utf-8') as file:
    ...
    for line in data_list:
        try:
            ...
            star_levels.append(split_label[0])
        except json.JSONDecodeError:
            print("JSON解析错误")

predic_list = [0 if star == 'mild' else 1 for star in star_levels]
...
label_list = [0 if star == 'mild' else 1 for star in star_levels]
...
plt.savefig('.\\大模型混淆矩阵\\B5.pdf')  # 注意文件路径中的斜杠
plt.show()
